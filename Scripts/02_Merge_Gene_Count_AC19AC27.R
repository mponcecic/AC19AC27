...
# Load gene count
counts_AC19 <- read.table("W:/mponce/AC19/04_STAR/RawCounts_AC19.txt", header = TRUE, sep = "\t")
counts_AC27 <- read.table("W:/mponce/AC27/04_STAR/RawCounts_AC27.txt", header = TRUE, sep = "\t")
head(counts_AC19)
head(counts_AC27)
